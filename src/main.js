...
cube =                     // model/cube-EXAMPLE.json
{
    "vertices" : [
        ...
        -0.35, -0.35, 0.3, //4
        0.35, -0.35, 0.3, // 5
        0.35, 0.35, 0.3, //6 changed
        -0.35, 0.35, 0.3, // 7 changed 

        //front cube inner
        -0.5, -0.5, 0.15, //8 changed
        0.5, -0.5, 0.15, // 9 changed
        0.5, 0.5, 0.15, // 10 changed
        -0.5, 0.5, 0.15, // 11 changed

        //front cube small inner
        -0.35, -0.35, 0.15, //12 changed
        0.35, -0.35, 0.15, // 13 changed
        0.35, 0.35, 0.15, // 14 changed
        -0.35, 0.35, 0.15, // 15 changed
